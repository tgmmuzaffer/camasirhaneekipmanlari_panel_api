        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MapAdress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Phone1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Phone2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WorkHour1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WorkHour2 = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pr_Fe_Relationals", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Fe_SubCat_Relationals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Fe_SubCat_Relationals_Features_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "Features",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeatureSubCategory", x => new { x.FeaturesId, x.SubCategoriesId });
                    table.ForeignKey(
                        name: "FK_FeatureSubCategory_Features_FeaturesId",
                        column: x => x.FeaturesId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FeatureSubCategory_SubCategories_SubCategoriesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Fe_SubCat_Relationals_FeatureId",
                table: "Fe_SubCat_Relationals",
                column: "FeatureId");

            migrationBuilder.CreateIndex(
                name: "IX_Fe_SubCat_Relationals_SubCategoryId",
                table: "Fe_SubCat_Relationals",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeatureSubCategory_SubCategoriesId",
                table: "FeatureSubCategory",
